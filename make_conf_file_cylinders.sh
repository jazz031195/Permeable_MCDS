...
path_to_conf="instructions/configuration_run.conf"
path_to_model="instructions/configuration_model_cyl.conf"

cp "$path_to_model" "$path_to_conf"
path_to_scheme="$path/docs/scheme_files/PGSE_sample_scheme_21_dir.scheme"
...
path_to_exp="$path/${name}"
replace_cylinder_list="$path/${input}"
...
sed -i s:replace_cylinder_list:"${replace_cylinder_list}":g "${path_to_conf}"
