...
scheme_file = "/home/localadmin/Documents/MCDC_perm_jas/Permeable_MCDS/results/test_juliette/21_dir_12_b_9_td.scheme"
...
g = sns.scatterplot(data=means, x='b [ms/um²]', y='Sb/So', hue='Delta [ms]', ax=ax, s=200)
