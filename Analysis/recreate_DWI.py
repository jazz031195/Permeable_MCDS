...
if __name__=="__main__":
    ...
    python recreate_DWI.py /home/localadmin/Documents/MCDC_perm_jas/Permeable_MCDS/results/test_juliette "_" --scheme /home/localadmin/Documents/MCDC_perm_jas/Permeable_MCDS/results/test_juliette/21_dir_12_b_9_td.scheme --propagator 0
    """
    ...
    if flag_signal:
        ...
        save_path_r_all = os.path.join(exp_path+'_DWI.bfloat')
    ...
    print(len(list_traj_files), list_traj_files)
