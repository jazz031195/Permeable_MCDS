...
/*! \class NeuronCollisionSphere
 *  \brief Class to save the Neuron obstacles that a can collide to a walker.
 */
class NeuronCollisionSphere: public Collisionsphere{
